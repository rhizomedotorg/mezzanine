...
class BlogPost(Displayable, Ownable, RichText, AdminThumbMixin):
    ...
    featured_image = models.ImageField(verbose_name=_("Featured Image"), upload_to=upload_to("blog.BlogPost.featured_image", "blog"), max_length=255, null=True, blank=True)
